...
(function (ID) {
    ...
    ID["NAVBAR_BUTTONUPDATECOLUMN"] = "updateColumnOpen";
})(ID || (ID = {}));
...
export const WRAPPER_MESSAGE_ALERT_INVALID_PHONE = (text) => {

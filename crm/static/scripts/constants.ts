...
export const TEXT_CONSTANT = {
    ...
    `,
<<<<<<< HEAD:crm/static/addLeads/constants.ts
...
>>>>>>> 453cce374ff098c8530e6b524ac54d1387231ee0:crm/static/scripts/constants.ts
...
const WRAPPER_QUERY_SELECTOR_FOR_CLASS_NAME = (classname:string): string => {
    return `.${classname}`;
} 
